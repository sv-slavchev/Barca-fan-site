...
$errors['email1'] = "Email field cannot be emptty ";
}
...
$errors['confirm1'] = "Confirm password field cannot be empty ";
}


if($password != $confirm_password){
	$errors['confirm2'] = "Value of field Confirm Password must be  equal to field Passwords";
...
$errors['username2'] = "There is user with this username already! Please choose another one.";
				...
				<div id="content" class="col-sm-8">
					...
					<div class="main-login main-center">
						...
						<form method="post" target="">
							...
							<div class="form-group">
								...
								<div>
									<div class="input-group">
										...
										<input type="text" class="form-control" name="username"   id="username"  placeholder="Моля въведете потребителско име" value="<?php if(isset($_POST['username'])) echo $_POST['username']; ?>" />
									</div>
							...
							<div class="form-group">
								<label for="email" class="control-label">Вашият имейл</label>
								<div>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-envelope fa" aria-hidden="true"></i></span>
										<input type="text" class="form-control" name="email" value="<?php if(isset($_POST['email'])) echo $_POST['email']; ?>" id="email"  placeholder="Моля въведете вашият имейл адрес"/>
									</div>
							...
							<div class="form-group">
								<label for="confirm" class="control-label">Повторете парола</label>
								<div>
									<div class="input-group">
										<span class="input-group-addon"><i class="fa fa-lock fa-lg" aria-hidden="true"></i></span>
										<input type="password" class="form-control" name="confirm"  id="confirm"  placeholder="Моля повторете вашата парола"/>
									</div>
									<p><?php if(isset($errors['confirm1'])) echo $errors['confirm1']; ?> </p>
									<p><?php if(isset($errors['confirm2'])) echo $errors['confirm2']; ?> </p>
								</div>
							</div>

							<div class="form-group ">
								<input  type="submit" id="button" name="reg" value="Регистрация" class="btn btn-primary btn-lg btn-block login-button" />
							</div>
