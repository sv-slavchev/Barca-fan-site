<?php
/* Smarty version 3.1.29, created on 2018-04-21 11:15:23
  from "C:\xampp\htdocs\BarcaTrain\results.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.29',
  'unifunc' => 'content_5adb012b9faeb7_61209860',
  'file_dependency' => 
  array (
    '36a7221323ba5fe2f09bd4624df568b17fca2282' => 
    array (
      0 => 'C:\\xampp\\htdocs\\BarcaTrain\\results.html',
      1 => 1524302117,
      2 => 'file',
    ),
  ),
...
function content_5adb012b9faeb7_61209860 ($_smarty_tpl) {
?>
<!DOCTYPE html>
		...
		<main class="col-xs-12 col-sm-12">
			<div class="content-results col-sm-8">
					...
					<div class="match-body col-sm-10">
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="col-sm-2">
									<h2><strong>3 - 1</strong></h2>
									<p><time><strong>27/05/2017</strong></time></p>
								</div>
								<div class="col-sm-5 club-logo-results">
									<div class="row"><img src="./img/standings/alaves.png" class=""></div>
									<p class="club-logo-results"><strong>Alavès</strong></p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="col-sm-2">
									...
									<p><time><strong>21/05/2017</strong></time></p>
								</div>
								<div class="col-sm-5 club-logo-results">
									<div class="row"><img src="./img/standings/eibar.png" class=""></div>
									<p class="club-logo-results"><strong>Eibar</strong></p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="match-result">
					...
					<div class="match-body col-sm-10">
						<div class="row">
							<div class="col-sm-12">
								<div class="col-sm-5 club-logo-results">
									<div class="row"><img src="./img/standings/las-palmas.png" class=""></div>
									<p class="club-logo-results"><strong>Las Palmas</strong></p>
								</div>
								<div class="col-sm-2">
									<h2><strong>1 - 4</strong></h2>
									<p><time><strong>14/05/2017</strong></time></p>
								</div>
								<div class="col-sm-5 club-logo-results">
									<div class="row"><img src="./img/standings/barcaa.png" class=""></div>
									<p class="club-logo-results"><strong>FC Barcelona</strong></p>
					...
					<div class="match-footer col-sm-12">
						<span id="city">CITY: Las Palmas de Gran Canaria</span><span id="stadium" class="pull-right">STADIUM: Estadio de Gran Canaria</span>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="col-sm-2">
									...
									<p><time><strong>06/05/2017</strong></time></p>
								</div>
								<div class="col-sm-5 club-logo-results">
									<div class="row"><img src="./img/standings/villareal.png" class=""></div>
									<p class="club-logo-results"><strong>Villareal</strong></p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="match-result">
					...
					<div class="match-body col-sm-10">
						<div class="row">
							<div class="col-sm-12">
								<div class="col-sm-5 club-logo-results">
									<div class="row"><img src="./img/standings/espanyol.png" class=""></div>
									<p class="club-logo-results"><strong>Españyol</strong></p>
								</div>
								<div class="col-sm-2">
									<h2><strong>0 - 3</strong></h2>
									<p><time><strong>29/04/2017</strong></time></p>
								</div>
								<div class="col-sm-5 club-logo-results">
									<div class="row"><img src="./img/standings/barcaa.png" class=""></div>
									<p class="club-logo-results"><strong>FC Barcelona</strong></p>
					...
					<div class="match-footer col-sm-12">
						<span id="city">CITY: Barcelona</span><span id="stadium" class="pull-right">STADIUM: RCDE Stadium</span>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="col-sm-2">
									...
									<p><time><strong>26/04/2017</strong></time></p>
								</div>
								<div class="col-sm-5 club-logo-results">
									<div class="row"><img src="./img/standings/osasuna.png" class=""></div>
									<p class="club-logo-results"><strong>Osasuna</strong></p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="match-result">
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="col-sm-2">
									...
									<p><time><strong>23/04/2017</strong></time></p>
								</div>
								<div class="col-sm-5 club-logo-results">
									<div class="row"><img src="./img/standings/barcaa.png" class=""></div>
									<p class="club-logo-results"><strong>FC Barcelona</strong></p>
					...
					<div class="match-footer col-sm-12">
						<span id="city">CITY: Madrid</span><span id="stadium" class="pull-right">STADIUM: Santiago Bernabéu</span>
					</div>
				</div>
				...
				<div class="match-result">
					<div class="match-header col-sm-2">
						<div class="match-header-content">
							<p>Champions League <br> Quarter final - 2nd Leg</p>
						</div>
					</div>
					<div class="match-body col-sm-10">
						<div class="row">
							<div class="col-sm-12">
								...
								<div class="col-sm-2">
									...
									<p><time><strong>19/04/2017</strong></time></p>
								</div>
								<div class="col-sm-5 club-logo-results">
