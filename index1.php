			...
			<div class="row">
				<div id="content" class="col-sm-8">
					...
					<div id="shopping-cart">
						...
						<table class="table table-hover table-bordered">
								...
								?>
												<tr>
													...
													<td><?php echo $item["price"]."лв."; ?></td>
													<td>
														<a href="index1.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction btn-sm"><span class="glyphicon glyphicon-remove"></span> Премахни</a>
													</td>
												</tr>
								...
								<tr>
									<td colspan="5" align="right"><strong>Обща сума: <?php echo $item_total."лв.";?></strong></td>
								</tr>
						    </tbody>
						</table>
						<?php
						...
						?>
						<a href="cart.php" class="btn btn-primary"><span class="glyphicon glyphicon-shopping-cart"></span> Обратно в магазина</a>
						<a class="btn btn-default" id="btnEmpty" href="index1.php?action=empty"><span class="glyphicon glyphicon-trash"></span> Изпразни кошница</a>
						<a href="payment.php" class="pull-right btn btn-success">Поръчай <span class="glyphicon glyphicon-play"></span></a>
					</div>
