				...
				<div class="container-fluid">
					...
					<div id="product-grid">
						<div class="col-md-8" id="content">
							...
							<?php
								$product_array = $db_handle->runQuery("SELECT * FROM tblproduct ORDER BY id ASC limit 9");
							...
							?>
										<div class="product-item col-xs-6 col-sm-4 col-md-3">
											<form method="post" action="index1.php?action=add&code=<?php echo $product_array[$key]['code']; ?>">
												<a id="imgalert" class="imgalert" href="review.php?action=review&code=<?php echo $product_array[$key]['code']; ?>">
													<div class="product-head">
														<div class="product-image">
															<img class="smallimg" src="<?php echo $product_array[$key]['image']; ?>">
														</div>
												...
												<div class="item-content">
													...
													<div class="product-price">
														<?php echo $product_array[$key]["price"]."лв."; ?>
													</div>
													<div>
														<!-- <input type="number" name="quantity" class="text-center col-xs-6" id="quantity" min="1" value="1"> -->
														<input type="number" name="quantity" class="text-center" id="quantity" min="1" value="1" max="{$quantity}">

														<!-- <div class="input-group number-spinner">
															<span class="input-group-btn data-dwn">
																<button class="btn btn-default btn-info" data-dir="dwn"><span class="glyphicon glyphicon-minus"></span></button>
															</span>
															<input type="text" class="form-control text-center" value="1" min="1" max="{$quantity}">
											...
											<!-- <form method="post" action="review.php?action=review&code=<?php echo $product_array[$key]['code']; ?>">
